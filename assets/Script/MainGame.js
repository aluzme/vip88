...
cc.Class({
	...
	fanpage: function(){
		cc.sys.openURL('http://vip88.io/fanpage/');
	},
	ios: function(){
		cc.sys.openURL('http://vip88.io/help/ios');
	},
	android: function(){
		cc.sys.openURL('http://vip88.io/download/android/' + this.fileAPK);
	},
	telegram: function(){
		cc.sys.openURL('http://vip88.io/telegram/');
		
	},
	cskh: function(){
		cc.sys.openURL('http://vip88.io/telegramcskh/');
